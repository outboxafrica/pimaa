...
if not os.path.isfile(command_path + 'sensors.cfg'):
	print "Unable to access config file: sensors.cfg"
	exit(1)

sensorConfig = ConfigParser.SafeConfigParser()
sensorConfig.read(command_path + 'sensors.cfg')
...
if not os.path.isfile(command_path + "outputs.cfg"):
	print "Unable to access config file: outputs.cfg"

outputConfig = ConfigParser.SafeConfigParser()
outputConfig.read(command_path + "outputs.cfg")
...
if not os.path.isfile(command_path + "settings.cfg"):
	print "Unable to access config file: settings.cfg"

mainConfig = ConfigParser.SafeConfigParser()
mainConfig.read(command_path + "settings.cfg")
...
nodeID = mainConfig.get("Node","nodeID")
